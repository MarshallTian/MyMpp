...
${OBJECTDIR}/Service/JniTest.o: Service/JniTest.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Service/JniTest.o Service/JniTest.cc

${OBJECTDIR}/Service/frontend.o: Service/frontend.cc 
	${MKDIR} -p ${OBJECTDIR}/Service
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Service/frontend.o Service/frontend.cc

${OBJECTDIR}/Service/jni-util.o: Service/jni-util.cc 
	${MKDIR} -p ${OBJECTDIR}/Service
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Service/jni-util.o Service/jni-util.cc

${OBJECTDIR}/Service/thrift-util.o: Service/thrift-util.cc 
	${MKDIR} -p ${OBJECTDIR}/Service
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Service/thrift-util.o Service/thrift-util.cc

${OBJECTDIR}/common/atomic-test.o: common/atomic-test.cc 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/atomic-test.o common/atomic-test.cc

${OBJECTDIR}/hdfs-scan-node.o: hdfs-scan-node.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hdfs-scan-node.o hdfs-scan-node.cc

${OBJECTDIR}/hdfs-text-scanner.o: hdfs-text-scanner.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hdfs-text-scanner.o hdfs-text-scanner.cc

${OBJECTDIR}/hdfs-text-scanner.cc.o: hdfs-text-scanner.cc.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hdfs-text-scanner.cc.o hdfs-text-scanner.cc.cpp

${OBJECTDIR}/runtime/hdfs-fs-cache.o: runtime/hdfs-fs-cache.cc 
	${MKDIR} -p ${OBJECTDIR}/runtime
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/runtime/hdfs-fs-cache.o runtime/hdfs-fs-cache.cc
